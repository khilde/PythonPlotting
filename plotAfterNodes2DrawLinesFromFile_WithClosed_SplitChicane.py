...
#drawingArray=[0.,1.51480,2.24164,2.38700,3.27006,4.09536,4.26042,5.35030,6.24055]
Length=drawingArray[len(drawingArray)-1]
midLine=.1
stripLength=.06
...
if stripper1CurrentLocation==0:
	chicane2=aBox(drawingArray[1]/Length,midLine/2.,drawingArray[4]/Length,midLine*3./2.)
elif splitChicane2:
	chicane2=aBox(drawingArray[1]/Length,midLine/2.,drawingArray[6]/Length,midLine*3./2.)
else:
	chicane2=aBox(drawingArray[1]/Length,midLine/2.,drawingArray[2]/Length,midLine*3./2.)	
...
if stripper1CurrentLocation==0:
	stripping1=aBox(drawingArray[1]/Length,midLine/1.5,drawingArray[2]/Length,midLine*2./1.5)
else:
	stripping1=aBox(drawingArray[2]/Length,midLine/1.5,drawingArray[4]/Length,midLine*2./1.5)
	
drift2=TLine(drawingArray[4]/Length,midLine,drawingArray[5]/Length,midLine)
if splitChicane2:
	drift2=TLine(drawingArray[6]/Length,midLine,drawingArray[7]/Length,midLine)
chicane3Start=5
if splitChicane2:
	chicane3Start=7
if stripper2CurrentLocation==0:
	chicane3=aBox(drawingArray[chicane3Start]/Length,midLine/2.,drawingArray[chicane3Start+3]/Length,midLine*3./2.)
elif splitChicane3:
	chicane3=aBox(drawingArray[chicane3Start]/Length,midLine/2.,drawingArray[chicane3Start+5]/Length,midLine*3./2.)
else:
	chicane3=aBox(drawingArray[chicane3Start]/Length,midLine/2.,drawingArray[chicane3Start+1]/Length,midLine*3./2.)
if stripper2CurrentLocation==0:
	stripping2=aBox(drawingArray[chicane3Start]/Length,midLine/1.5,drawingArray[chicane3Start+1]/Length,midLine*2./1.5)
else:
	stripping2=aBox(drawingArray[chicane3Start+1]/Length,midLine/1.5,drawingArray[chicane3Start+3]/Length,midLine*2./1.5)
drift3=TLine(drawingArray[chicane3Start+3]/Length,midLine,drawingArray[chicane3Start+4]/Length,midLine)
if splitChicane3:
	drift3=TLine(drawingArray[chicane3Start+5]/Length,midLine,drawingArray[chicane3Start+6]/Length,midLine)	
chicane4=aBox(drawingArray[chicane3Start+4]/Length,midLine/2.,drawingArray[chicane3Start+5]/Length,midLine*3./2.)
foil2=TLine(drawingArray[chicane3Start+4]/Length,midLine*.4,drawingArray[chicane3Start+4]/Length,midLine*1.6)
if splitChicane3:
	chicane4=aBox(drawingArray[chicane3Start+6]/Length,midLine/2.,drawingArray[chicane3Start+7]/Length,midLine*3./2.)
	foil2=TLine(drawingArray[chicane3Start+6]/Length,midLine*.4,drawingArray[chicane3Start+6]/Length,midLine*1.6)

drift4=TLine(drawingArray[chicane3Start+5]/Length,midLine*.4,drawingArray[chicane3Start+6]/Length,midLine*1.6)
if splitChicane3:
	drift4=TLine(drawingArray[chicane3Start+7]/Length,midLine,drawingArray[chicane3Start+8]/Length,midLine)
