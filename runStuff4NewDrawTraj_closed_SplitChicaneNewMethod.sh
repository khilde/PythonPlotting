...
directory=WasteBeamSplitGeneralNewStripperChicaneFieldAddedCleanNewOppisite
directory2=WasteBeamSplitGeneralClosedBeamOpposite
stripperLocation=(0 1 2 3 4 5 6)

for i in ${stripperLocation[@]}
do
    python plotAfterNodes2DrawLinesFromFile_WithClosed_SplitChicaneNewMethod.py --directory "$directory" --directoryClosed "$directory2" --stripper1Location "$i" --imageType "pdf"
