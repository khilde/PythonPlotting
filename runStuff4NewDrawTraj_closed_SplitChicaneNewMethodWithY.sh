...
directory=WasteBeamSplitGeneralNewStripperChicaneFieldAddedCleanNewTestY
directory2=WasteBeamSplitGeneralClosedBeamNewY
stripperLocation=(0 1 2 3 4 5 6)

for i in ${stripperLocation[@]}
do
    python plotAfterNodes2DrawLinesFromFile_WithClosed_SplitChicaneNewMethodWithY.py --directory "$directory" --directoryClosed "$directory2" --stripper1Location "$i" --imageType "pdf"
    python plotAfterNodes2DrawLinesFromFile_WithClosed_SplitChicaneNewMethodWithY.py --doY 1 --directory "$directory" --directoryClosed "$directory2" --stripper1Location "$i" --imageType "pdf"
